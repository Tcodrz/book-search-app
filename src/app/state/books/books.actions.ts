...
export const search = createAction('[BOOKS] Search', props<{payload: string}>());
...
export const addedToWishList = createAction('[BOOKS] Added To WishList', props<{ payload: Book}>());
export const removeFromWishList = createAction('[BOOKS] Remove From WishList', props<{ payload: Book}>());
export const removedFromWishList = createAction('[BOOKS] Removed From WishList', props<{ payload: Book}>());
export const setWishList = createAction('[BOOKS] Set WishList', props<{ payload: Book[]}>());
